...
export const sidebarTheme: SidebarTheme = {
  root: {
    ...
    inner: 'h-full overflow-y-auto overflow-x-hidden rounded bg-gray-50 py-4 px-3 ',
  },
  collapse: {
    button:
      'group flex w-full items-center rounded-lg p-2 text-base font-normal text-gray-900 transition duration-75 hover:bg-white-100',
    icon: {
  ...
  item: {
    ...
    icon: {
      base: 'h-6 w-6 flex-shrink-0 text-gray-400 transition duration-75 hover:text-blue-600 ',
      active: 'text-gray-700 hover:text-blue-200',
    },
    label: '',
    listItem: '',
  },
