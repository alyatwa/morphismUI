...
export interface SidebarCollapseProps
  ...
  renderChevronIcon?: (theme: DeepPartial<SidebarCollapseTheme>, open: boolean) => ReactElement;
    ...
    <Wrapper>
      ...
      >
        ...
        {isCollapsed ? (
          ...
          <>
            <span data-testid="sidebar-collapse-label" className={theme.label.base}>
              {label}
            </span>
            {renderChevronIcon ? (
      ...
      <ul aria-labelledby={`sidebar-collapse-${id}`} hidden={!isOpen} className={theme.list}>
