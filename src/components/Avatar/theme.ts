...
export const avatarTheme: AvatarTheme = {
  root: {
    ...
    status: {
      away: 'bg-yellow-400',
      base: 'absolute h-4 w-4 rounded-full border-2 border-white',
      busy: 'bg-red-400',
      offline: 'bg-gray-400',
      online: 'bg-green-400',
    },
  ...
  groupCounter: {
    base: 'relative flex items-center justify-center w-10 h-10 text-xs font-medium text-black bg-white rounded-full ring-2 ring-gray-100 hover:bg-white',
  },
};