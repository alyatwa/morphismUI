...
export const buttonTheme: ButtonTheme = {
  ...
  color: {
    ...
    transparent: 'text-blue-600 bg-blue-200 dark:bg-blue-100',

    info: 'text-white bg-blue-700 dark:bg-blue-600 ',
    light:
    ...
    blue: 'text-cyan-900 bg-white border border-cyan-300 focus:ring-4 focus:ring-cyan-300 :bg-cyan-600 dark:text-white dark:border-cyan-600 ',
